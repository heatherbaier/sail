# src/sail/cli/main.py

import typer
from ..engine import run as run_pipeline

app = typer.Typer(help="SAIL CLI")

@app.command()
def run(config: str = typer.Argument(..., help="Path to YAML config")):
    """
    Run full pipeline described in the YAML config:
